...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # I imagine a machine that in these cases does sum + item or product * item
    # over and over. Inject just "injects" elements into this flow of operations
    # starting with the argument it is passed as the first var of the block
    # and the first element of the receiver as the second var of the block
  end
  ...
  # Allows us to simply replace the block in the code and reuse it later?
